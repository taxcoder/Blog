 ...
 * @Date: 2025-01-02 03:02:34
 * @LastEditTime: 2025-01-08 14:58:12
 * @FilePath: /code/blog/client-web/src/common/page-loading-light/Index.vue
 * @Description: 
 * Copyright (c) 2025 by tanxiang, All Rights Reserved. 
-->
<template>
  <div id="loading" :style="{ background: props.background }">
    <div class="cat" :style="{ transform: `scale(${props.scale})`, width: props.width, height: props.height }">
...
.dark #loading {
  background-color: rgb(140 117 75) !important;
}
...
.cat__segment:first-of-type:before {
  background: radial-gradient(0.25em 0.25em at 1.25em 1.6em, white 48%, rgba(255, 255, 255, 0) 50%),
